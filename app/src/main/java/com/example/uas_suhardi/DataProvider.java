package com.example.uas_suhardi;
...
import com.example.uas_suhardi.model.Anjing;
import com.example.uas_suhardi.model.Hewan;
import com.example.uas_suhardi.model.Kucing;
import com.example.uas_suhardi.model.Kuda;
...
public class DataProvider {
    ...
    private static List<Kuda> initDataReptil(Context ctx) {
        List<Kuda> reptils = new ArrayList<>();
        reptils.add(new Kuda(ctx.getString(R.string.buaya_nama), ctx.getString(R.string.buaya_asal),
                ctx.getString(R.string.bengal_deskripsi), R.drawable.kuda_appalosa));
        reptils.add(new Kuda(ctx.getString(R.string.bunglon_nama), ctx.getString(R.string.bunglon_asal),
                ctx.getString(R.string.bunglon_deskripsi), R.drawable.kuda_arab));
        reptils.add(new Kuda(ctx.getString(R.string.komodo_nama), ctx.getString(R.string.komodo_asal),
                ctx.getString(R.string.komodo_deskripsi), R.drawable.kuda_clydesdale));
        reptils.add(new Kuda(ctx.getString(R.string.penyu_nama), ctx.getString(R.string.penyu_asal),
                ctx.getString(R.string.penyu_deskripsi), R.drawable.kuda_kuartal));
        reptils.add(new Kuda(ctx.getString(R.string.tuatara_nama), ctx.getString(R.string.tuatara_asal),
                ctx.getString(R.string.tuatara_deskripsi), R.drawable.kuda_morgan));
        reptils.add(new Kuda(ctx.getString(R.string.ular_nama), ctx.getString(R.string.ular_asal),
                ctx.getString(R.string.ular_deskripsi), R.drawable.kuda_thoroughbred));
        return reptils;
    }
